//This logic is for digital watch
...
//This logic is for Temperature Converter
...
function temperature() {
    ...
    if (inputValue == "") {
        alert("Pleace Enter Any Number Here......")
        location.reload()
    }
        ...
        let Kelvin = Number.parseInt(inputValue) * + 273.25
        ...
        let Celcius = Number.parseInt(inputValue) - 32 * (9 / 5)
        result.innerHTML = Celcius.toFixed(3) + `&deg;C`
    }
        ...
        let Kelvin = Number.parseInt(inputValue) - 32 * (9 / 5) + 273.15
        result.innerHTML = Kelvin.toFixed(3) + " K"
    }
